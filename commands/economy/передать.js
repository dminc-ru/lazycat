	...
	async run (client, interaction) {
		try {
			...
			if(userdb.balance_fish < money) {
				let noMoney = client.utils.error(`У вас недостаточно средств.\nВаш баланс: ${userdb.balance_fish} ${client.emoji.fish}`)
			...
			let successTransaction = client.utils.success(`Успешно! Переведено ${money} ${client.emoji.fish}.\nВаш баланс: ${userdb.balance_fish - money} ${client.emoji.fish}`, user)
